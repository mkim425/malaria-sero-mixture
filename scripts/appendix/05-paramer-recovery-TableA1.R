...
df_results_setting1 <- readRDS("data/informative-mdl-fit-simdata-setting1-outputs-summary.rds")
df_results_setting2 <- readRDS("data/informative-mdl-fit-simdata-setting2-outputs-summary.rds")
df_results_setting3 <- readRDS("data/informative-mdl-fit-simdata-setting3-outputs-summary.rds")
